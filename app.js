...
document.getElementById('first-name').value = 'Feroz';

//// v. Repeat part iv for id ”last-name” and “email”.

document.getElementById('last-name').value = 'khosa';

document.getElementById('emaill').value = 'ferozkhosa12@gmail.com';
